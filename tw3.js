// ====== SISTEM MANAJEMEN BAP - VERSI 3 ======

let db;
const DB_NAME = 'SistemBAPDatabase_v3';
const DB_VERSION = 1;
...
function tampilkanTabel(filterData = null) {
    const tbody = document.querySelector('.userBarang3');
    if (!tbody) return;
...
function updateInfo(mulai, akhir, total) {
    const info = document.querySelector('.showEntries3');
    if (info) {
...
function filterTable() {
    const input = document.getElementById('brId3');
    if (!input) return;
...
function bersihkanForm() {
    const fields = ['NOS3', 'TGL3', 'PIHAK1t3', 'NIP1t3', 'JBT1t3', 'PIHAK2t3', 'NIP2t3', 'JBTt3', 'NOBAP3'];
...
async function saveData() {
    ...
    try {
        ...
        const data = {
            ...
            PIHAK1: document.getElementById('PIHAK1t3')?.value?.trim() || '',
            NIP1: document.getElementById('NIP1t3')?.value?.trim() || '',
            JBT1: document.getElementById('JBT1t3')?.value?.trim() || '',
            PIHAK2: document.getElementById('PIHAK2t3')?.value?.trim() || '',
            NIP2: document.getElementById('NIP2t3')?.value?.trim() || '',
            JBT2: document.getElementById('JBTt3')?.value?.trim() || '',
            NOBAP: document.getElementById('NOBAP3')?.value?.trim() || '',
            items: items
        };
...
async function editData(id) {
    ...
    setVal('PIHAK1t3', data.PIHAK1);
    setVal('NIP1t3', data.NIP1);
    setVal('JBT1t3', data.JBT1);
    setVal('PIHAK2t3', data.PIHAK2);
    setVal('NIP2t3', data.NIP2);
    setVal('JBTt3', data.JBT2);
    setVal('NOBAP3', data.NOBAP);
...
async function init() {
    ...
    try {
        ...
        const btnAdd = document.getElementById('addBtn3');
        if (btnAdd) {
        ...
        const btnClose = document.getElementById('closeModal3');
        if (btnClose) {
        ...
        const btnSave = document.getElementById('submitBtn3');
        if (btnSave) {
        ...
        const selectSize = document.getElementById('table_size3');
        if (selectSize) {
        ...
        const btnSearch = document.querySelector('.search3');
        if (btnSearch) {
        ...
        const inputSearch = document.getElementById('brId3');
        if (inputSearch) {
